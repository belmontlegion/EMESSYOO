...
- **Visual Loop Editor**: DAW-style waveform view with draggable loop markers
- **Normalization**: RMS and peak-based normalization with folder analysis
...
Created and maintained by **Scott McKay (BelmontLegon)** — [github.com/belmontlegion/EMESSYOO](https://github.com/belmontlegion/EMESSYOO/)
